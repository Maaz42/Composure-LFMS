...
export default function IntakeList() {
  ...
  const forwardQuickActionDropDown = [
    {
      label: (
        <div style={{ display: "flex" }}>
          <Image style={{ marginRight: "5px" }} src={IRONCLAD} alt="..." />
          Ironclad
        </div>
      ),
      key: "0",
    },
    {
      label: (
        <div style={{ display: "flex" }}>
          <Image style={{ marginRight: "5px" }} src={BRIGHTFLAG} alt="..." />
          Brightflag
        </div>
      ),
      key: "1",
    },
    {
      label: (
        <div style={{ display: "flex" }}>
          <Image style={{ marginRight: "5px" }} src={ICERTIS} alt="..." />
          Icertis
        </div>
      ),
      key: "2",
    },
    {
      label: (
        <div style={{ display: "flex" }}>
          <Image style={{ marginRight: "5px" }} src={GOOGLEDRIVE} alt="..." />
          Google Drive
        </div>
      ),
      key: "3",
    },
    {
      label: (
        <div style={{ display: "flex" }}>
          <Image style={{ marginRight: "5px" }} src={DROPBOX} alt="..." />
          Dropbox
        </div>
      ),
      key: "4",
  ...
  const ticketDropDown = [
    {
      key: "1",
      label: <a onClick={showViewDrawer}>View</a>,
    },
    {
      key: "3",
      label: "Mark Urgent",
      ...
      >
        ...
        >
          ...
          <div className="mt-2">
            ...
            >
              <div className={styles.titleClr}>Status</div>
              <div>Pending</div>
            </Row>
            <Row
              className="mb-2"
            ...
            >
              <div className={styles.titleClr}>Source</div>
              <div className={styles.answer}>Slack</div>
            </Row>
            <Row
              className="mb-2"
              style={{
            ...
            >
              <div className={styles.titleClr}>Created By</div>
              <div>Alex Rose</div>
            </Row>
            <Row
              className="mb-2"
            ...
            >
              <div className={styles.titleClr}>Created At</div>
              <div>3 days ago</div>
            </Row>
            <Row
              className="mb-2"
            ...
            >
              <div className={styles.titleClr}>Linked Projects</div>
              <div>- </div>
            </Row>
            <Row
              className="mb-2"
            ...
            >
              <div className={styles.titleClr}>Linked Tickets</div>
              <div>- </div>
            </Row>
            <Divider></Divider>
        ...
        >
          <div>
            ...
            <div style={{ marginTop: "55px" }}>Add Documents</div>
            <div>
              <Dragger {...props}>
        ...
        >
          <div className="mb-5">
            <FloatLabel label="Title" value={mergeIntakeTitle}>
              <Input
                style={{ height: "48px" }}
                value={mergeIntakeTitle}
                onChange={(e) => setMergeIntakeTitle(e.target.value)}
              />
            </FloatLabel>
          </div>
        </Drawer>
        <Drawer
          title={
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              <Image src={CLOSE} height={18} alt="..." onClick={onClose} />
              <h2
                style={{ color: "#fff", marginRight: "95px", marginTop: "3px" }}
              >
                Create Project
              </h2>
              <Button
          ...
          <div className="example">
            <div className="mb-5">
              <FloatLabel label="Requested By" value={ticketRequestedBy}>
                <Input
                  style={{ height: "48px" }}
                  value={ticketRequestedBy}
                  onChange={(e) => setTicketRequestedBy(e.target.value)}
                />
              </FloatLabel>
            </div>
            <div className="mb-5">
              ...
              <FloatLabelArrow label="Status" value={selectStatusValue}>
                ...
                >
                  ...
                  <Option value="initailReview">
                    <div style={{ display: "flex", color: "#FF9800" }}>
                      <Image
                        src={YELLOWDOT}
                        height={10}
                        alt=""
                  ...
                  <Option value="In Progress">
                    <div style={{ display: "flex", color: "#2196F3" }}>
                      <Image
                        src={BLUEDOT}
                        height={10}
                        alt=""
        ...
        >
          <div className="example">
            <div style={{ color: "#9E9E9E", marginBottom: "10px" }}>
              Add Task To
            </div>
            {existingTask ? (
              <>
        ...
        >
          ...
          <div>
            ...
            >
              ...
              <div style={{ display: "flex" }}>
                Slack
                <Image src={SLACK} alt=",,," style={{ marginLeft: "10px" }} />
              </div>
            </div>
            <div
              style={{
